...
public class ItemSpawner1_13_R2 implements ItemSpawnerINT {
    ...
    public void setItemSpawner(Player p, ItemSpawnerType ist, Location loc) {
        ...
        net.minecraft.server.v1_13_R2.NBTTagCompound nbtTileEntity = new net.minecraft.server.v1_13_R2.NBTTagCompound();
        ...
        net.minecraft.server.v1_13_R2.ItemStack itemStack = CraftItemStack.asNMSCopy(items2);
    ...
    public void setItemSpawner(ItemSpawnerType ist, Location loc) {
        ...
        NBTTagCompound itemstack = new NBTTagCompound();
        NBTTagCompound itemStackTag = new NBTTagCompound();
        net.minecraft.server.v1_13_R2.ItemStack itemStack = CraftItemStack.asNMSCopy(ist.getNecikaracagi().getItemStack());
        itemStack.save(itemStackTag);
        itemstack.setString("id", "Item");
        itemstack.set("Item", itemStackTag);
        nbtTileEntity.set("SpawnData", itemstack);
