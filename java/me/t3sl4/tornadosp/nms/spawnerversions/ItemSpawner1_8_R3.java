...
public class ItemSpawner1_8_R3 implements ItemSpawnerINT {
   public void setItemSpawner(Player p, ItemSpawnerType ist, Location loc) {
      ...
      net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(items2);
   ...
   public void setItemSpawner(ItemSpawnerType ist, Location loc) {
      ...
      nbtTileEntity.setString("EntityId", "Item");
      NBTTagCompound itemTag = new NBTTagCompound();
      net.minecraft.server.v1_8_R3.ItemStack itemStack = CraftItemStack.asNMSCopy(ist.getNecikaracagi().getItemStack());
      NBTTagCompound itemStackTag = new NBTTagCompound();
      itemStack.save(itemStackTag);
      itemTag.set("Item", itemStackTag);
      nbtTileEntity.set("SpawnData", itemTag);
